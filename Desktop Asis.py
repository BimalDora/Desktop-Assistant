...
def send_email(receiver, content):
    """for this function to work, you must enable low security in your gmail which you are going to use to send mails"""
    server = smtplib.SMTP("smtp.gmail.com", 587)
    server.ehlo()
    server.starttls()
    server.login("usergmail@gmail.com", "password")
    server.sendmail("usergmail@gmail.com", receiver, content)
    server.close()
...
def Introduction():
    speak("I am JARVIS 1.0 , Personal AI assistant , "
          "I am created by Bimal , "
          "I can help you in various regards , "
          "I can search for you on the Internet , "
          "I can also grab definitions for you from wikipedia , "
          "In layman terms , I can try to make your easier and less stressful , "
          "Where you just have to command me , and I will do it for you , ")


def Creator():
    speak("Bimal is an extra-ordinary person ,"
          "He has a passion for Artificial Intelligence, Machine Learning , Data Science, Aeronautics"
...
if __name__ == '__main__':
    ...
    while True:
        ...
        if 'time' in query:
            ...
            speak("Thanks to Bimal. further it is a secret")
        ...
        # show location on map
            ...
            speak("I'm a machine. I can't be your girlfriend")
